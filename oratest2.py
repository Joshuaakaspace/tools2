...
class CustomChatModelAdvanced(BaseChatModel):
    """
    A custom chat model that interacts with the ORA model using ora.chat() directly.
    ...
    model_name: str
    """The name of the ORA model"""

    def __init__(self, model_name: str):
        self.model_name = model_name
        self.ora_connection = ora(engine=self.model_name)  # Initialize ORA model connection
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        """
        Generate the response by calling the ORA model using ora.chat().
        ...
        # Call the ORA model using ora.chat()
...
# Initialize the custom ORA model with the model name (e.g., "llama2")
